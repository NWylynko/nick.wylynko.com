...
export function Background() {
  ...
  return (
    <Container>
      <Triangle   colour={colours.yellowOrange} size={250}                            x={width * 0.1 - 200} y={100} />
      <Circle     colour={colours.blue} radius={200}                                  x={width * 0.2 + 200} y={-200} />
      ...
      <Circle     colour={colours.cyanBlue} radius={150}                              x={width * -0.05} y={700} />
      <Triangle   colour={colours.yellow} size={250}                                  x={width * 0.15 - 350} y={850} />
      <Rectangle  colour={colours.magentaRed} height={400} width={450} radius={10}    x={width * 0.11 - 50} y={850} />
      <Triangle   colour={colours.green} size={100}                                   x={width * -0.2 + 900} y={800} />
